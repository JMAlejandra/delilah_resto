...
const updateUserById = `UPDATE users SET full_name = :full_name, username = :username, email = :email, phone = :phone, address = :address, user_password = :user_password WHERE id = :id;`
